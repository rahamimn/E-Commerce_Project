...
export var E_Commerce_system_failier_logger = require('logger').createLogger('E_Commerce_system_failier_logger.log'); // logs to a file
...
export async function addToSystemFailierLogger(string_func_name) {
  ...
  E_Commerce_system_failier_logger.info("error in func: ", string_func_name );
}
