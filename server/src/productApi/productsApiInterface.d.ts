...
export interface IProductApi{
    ...
    addProduct: (storeId: String, amountInventory: Number, sellType: String, price: Number, rank: Number, reviews: String[], keyWords: String[], category: String) =>  Promise< {status:Number, err?: String   }>, //amount-in the shop, selltype- regular auction lottery
