...
export interface IProductApi{
    ...
    setProdactActivation: (userId: String, productId: String,toActivate?:boolean) => Promise< { status: number ,error?: String, product?:Product   }>,
    updateProduct: (userId: String, storeId: String, productId: String, productDetails: Object) => Promise< { status: number ,error?: String, product?:Product   }>,
    getProducts: (filter:{storeId?:String, category?: String, keyWords?: String[], name?:String},includeDisabled?:boolean) => Promise< {status:number, error?: String, products?:Product[]   }>, 
